...
?>
        ...
        <br><br><br><br>
        <h3 align="center"> Search Blood Donors</h3>
        <br>
        <?php
        echo" <form action='request.php' method='post' autocomplete='on'>
       <table class=table>
        ...
        <tr>
         ...
         <tr>
            <td><label for=inputState>City</label></td>
 ...
 echo" </thead>
  <tbody>";
        ...
        //echo $city;
        if($blood=='any')
            $qry="select * from singleuser where city='$city'";//where city=$city AND bloodtype=$blood";
        else
            $qry="select * from singleuser where city='$city' and bloodtype='$blood'";
        $res=mysqli_query($link, $qry);
        $c=0;
